...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
            //Arka planda SQL tarafına gönderdiği sorgu örneği : select count(*) from products where categoryId = 1
        ...
        {
            var result = _productDal.GetAll(p => p.ProductName == productName).Any(); // linq sorgusuna uyan kayıt varsa true döner.
            if (result)
            {
